      ...
      <div className='h-[70vh] w-[100%] mt-[6vh]  flex items-center gap-9'>
           ...
           whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 1 }}
             className='font-[Home] text-white text-4xl'>She sang the wind’s song—not with voice, but with heart. The skies listened, and in her rhythm, they remembered peace.</motion.h2>
            </div>
    </div>
  )
}
